...
CREATE TABLE `English_test` (
  ...
  `testtype` varchar(2) CHARACTER SET utf8 COLLATE utf8_unicode_520_ci DEFAULT '' COMMENT '问题类型（1选择，2简答）',
  `answera` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_520_ci DEFAULT '' COMMENT '答案A',
  `answerb` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_520_ci DEFAULT '' COMMENT '答案B',
  `answerc` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_520_ci DEFAULT '' COMMENT '答案C',
  `answerd` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_520_ci DEFAULT '' COMMENT '答案D',
  `answertrue` varchar(100) DEFAULT NULL COMMENT '正确答案',
  `testkey` varchar(2) CHARACTER SET utf8 COLLATE utf8_unicode_520_ci DEFAULT NULL COMMENT '试卷级别（1小学，2中学，3初中，4高中，5大学）',
...
-- ----------------------------
INSERT INTO `English_test` VALUES ('1', '1', 'are you OK?', '1', 'A YES', 'B NO', 'C I am not sure', 'D HAHA', 'C', '1', null);
INSERT INTO `English_test` VALUES ('10', '10', 'are you OK?', '1', 'A YES', 'B NO', 'C I am not sure', 'D HAHA', 'C', '1', null);
